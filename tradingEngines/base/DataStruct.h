...
struct RspPositionField
{
	...
	HedgeFlagType      	HedgeFlag;             //投机套保标志
	PosiDirectionType  	PosiDirection;         //持仓多空方向
};
...
struct InputOrderField
{
	...
	int                        	Volume;                //数量
	int                        	MinVolume;             //最小成交量
	TimeConditionType        	TimeCondition;         //有效期类型
	VolumeConditionType      	VolumeCondition;       //成交量类型
	OrderPriceTypeType       	OrderPriceType;        //报单价格条件
	DirectionType            	Direction;             //买卖方向
	OffsetFlagType           	OffsetFlag;            //开平标志
	HedgeFlagType            	HedgeFlag;             //投机套保标志
	ForceCloseReasonType     	ForceCloseReason;      //强平原因
	double                     	StopPrice;             //止损价
	int                        	IsAutoSuspend;         //自动挂起标志
	ContingentConditionType  	ContingentCondition;   //触发条件
...
struct RtnOrderField
{
	...
	OffsetFlagType       	OffsetFlag;            //开平标志
	HedgeFlagType        	HedgeFlag;             //投机套保标志
	OrderStatusType      	OrderStatus;           //报单状态
	int                    	RequestID;             //请求编号
};
*/
